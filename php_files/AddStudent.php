    ...
    <body class="hold-transition skin-yellow-light sidebar-mini">
        <div class="wrapper">
            ...
            <div class="content-wrapper">   
                ...
                <div class="container">  
                    <form action="AddStudentAction.php">
                        <h3> Add Student </h3>
                        <div class="row">
                            <label for="enrollNo">Enrollment Number :</label>
                            <input type="text" name="enrollNo" class="browser-default">
                        </div>
                        <div class="row">
                            <label for="fname">First Name :</label>
                            <input type="text" name="fname" class="browser-default">
                        </div>
                        <div class="row">
                            <label for="mname">Middle Name:</label>
                            <input type="text" name="mname" class="browser-default">
                        </div>
                        <div class="row">
                            <label for="lname">Last Name:</label>
                            <input type="text" name="lname" class="browser-default">
                        </div>
                        <div class="row">
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="nokt" id="nokt" class="browser-default">
                        </div>
                        ...
                        <div class="row">
                            ...
                            <input type="text" name="avgcode" id="avgcode" class="browser-default">
                        </div>
